function [ wavArray ] = sim_source_wav( arrayElements, sourceLoc, soundWav,speedOfSound, noise, samplerate)
%SIMULATESOURCEWAV Creates an array simulating the multichannel sound that
%would be recieved from a sdource at a specified location
...
%works out the time it would take to travel from the source location to
%each element. 
